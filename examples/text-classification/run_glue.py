...
from transformers.models.bert.modeling_bert_moe import CometBertForSequenceClassification
...
class DataTrainingArguments:
    ...
    max_val_samples: Optional[int] = field(
        default=None,
        metadata={"help": "For debugging purposes or quicker training, truncate the number of validation examples to this " "value if set."},
    )
    max_test_samples: Optional[int] = field(
        default=None, metadata={"help": "For debugging purposes or quicker training, truncate the number of test examples to this " "value if set."}
    )
...
class ModelArguments:
    ...
    preprocess_importance: Optional[bool] = field(default=False, metadata={"help": "Whether to pre-compute model importance."})
    cometbert: Optional[str] = field(default=None, metadata={"help": "Whether to use MoE."})
    cometbert_distill: Optional[float] = field(default=0.0, metadata={"help": "Constant for distillation."})
    cometbert_expert_dim: Optional[int] = field(default=1024, metadata={"help": "Dimension of experts."})
    cometbert_expert_dropout: Optional[float] = field(default=0.1, metadata={"help": "Dropout for FFNs in MoE."})
    cometbert_expert_num: Optional[int] = field(default=4, metadata={"help": "Number of experts in MoE."})
    cometbert_load_balance: Optional[float] = field(
        default=0.0, metadata={"help": "Weight of load balancing loss, only used with trainable gating mechanism."}
    )
    cometbert_load_experts: Optional[bool] = field(default=False, metadata={"help": "Whether to load a MoE model."})
    cometbert_load_importance: Optional[str] = field(default=None, metadata={"help": "Load the pre-computed importance."})
    cometbert_route_hash_list: Optional[str] = field(default=None, metadata={"help": "Path to the saved hash list."})
    cometbert_route_method: Optional[str] = field(
        default="hash-random", metadata={"help": "Choose from gate-token, gate-sentence, hash-random and hash-balance."}
    )
    cometbert_share_importance: Optional[int] = field(default=512, metadata={"help": "Amount of neurons to share across experts."})
    cometbert_gate_gamma: Optional[float] = field(default=1, metadata={"help": "value of gamma to use in the soft trees gating mechanism."})
    cometbert_gate_entropy: Optional[float] = field(default=1, metadata={"help": "value of entropy to use in the entropy regularizer for gating."})
    cometbert_perm_epoch: Optional[float] = field(default=1, metadata={"help": "value of entropy to use in the entropy regularizer for gating."})
    cometbert_k: Optional[float] = field(default=1, metadata={"help": "value of k for the number of experts"})
    apply_lora: Optional[bool] = field(default=False, metadata={"help": "Whether to apply LoRA or not."})
    lora_alpha: Optional[int] = field(default=None, metadata={"help": "LoRA alpha"})
    lora_r: Optional[int] = field(default=None, metadata={"help": "LoRA r"})
    ...
    reg_loss_wgt: Optional[float] = field(default=0.0, metadata={"help": "Regularization Loss Weight"})
    masking_prob: Optional[float] = field(default=0.0, metadata={"help": "Token Masking Probability"})
...
def main():
    ...
    config.cometbert = model_args.cometbert
    if config.cometbert is not None:
        config.cometbert = config.cometbert.lower()
    config.cometbert_distill = model_args.cometbert_distill
    config.cometbert_expert_dim = model_args.cometbert_expert_dim
    config.cometbert_expert_dropout = model_args.cometbert_expert_dropout
    config.cometbert_expert_num = model_args.cometbert_expert_num
    config.cometbert_load_balance = model_args.cometbert_load_balance
    config.cometbert_load_experts = model_args.cometbert_load_experts
    config.cometbert_load_importance = model_args.cometbert_load_importance
    config.cometbert_route_hash_list = model_args.cometbert_route_hash_list
    config.cometbert_route_method = model_args.cometbert_route_method
    config.cometbert_share_importance = model_args.cometbert_share_importance
    config.cometbert_gate_gamma = model_args.cometbert_gate_gamma
    config.cometbert_gate_entropy = model_args.cometbert_gate_entropy
    config.cometbert_perm_epoch = model_args.cometbert_perm_epoch
    config.cometbert_k = model_args.cometbert_k
    ...
    if config.cometbert == "moe":
        if config.model_type == "bert":
            meta_model = CometBertForSequenceClassification
        else:
    ...
    if training_args.do_eval:
        ...
        if config.cometbert_load_experts:
